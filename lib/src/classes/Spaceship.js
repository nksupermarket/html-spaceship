...
var rocket_lightmode_png_1 = __importDefault(require("../assets/rocket-lightmode.png"));
...
var Spaceship = /** @class */ (function (_super) {
    ...
    function Spaceship(_a) {
        var x = _a.x, y = _a.y;
        var _this = _super.call(this, x, y, constants_1.SS_DIM.height, constants_1.SS_DIM.width) || this;
        _this.speed = 10;
    ...
    Spaceship.prototype.bounce = function (bounds, boundaries) {
        ...
        boundaries.forEach(function (boundary) {
            var collision;
            if (boundary.circle) {
                collision = checkCollision_1.checkCollisionBtwnCircleAndRect(boundary, _this.getCorners('with velocity'), _this.getVertices('with velocity'));
            }
            else {
                for (var i = 0; i < edges.length; i++) {
                    collision = checkCollision_1.checkShipEdgeCollision(edges[i], boundary);
                    if (collision)
                        break;
                }
            }
