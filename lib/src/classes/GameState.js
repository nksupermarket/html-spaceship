...
var getStartPos_1 = __importDefault(require("../utils/getStartPos"));
var GameState = /** @class */ (function () {
    function GameState(startPos) {
        ...
        this.spaceship = new Spaceship_1.default(startPos || getStartPos_1.default(this.boundaries.list));
    ...
    GameState.prototype.update = function () {
        ...
        // handle scroll
        function shift(translateVal, change) {
        ...
        if (this.spaceship.y < this.scrollBoundary.bottom &&
            ...
            if (Math.abs(translateVal_1) <
                ...
                shift.call(this, translateVal_1, this.spaceship.velocity.y);
            }
            else {
                shift.call(this, -(document.documentElement.scrollHeight - window.innerHeight), document.documentElement.scrollHeight -
                    window.innerHeight -
                    Math.abs(misc_1.getTranslateY(document.body)));
            }
        }
        if (this.spaceship.y > this.scrollBoundary.top &&
            ...
            if (translateVal_2 < 0) {
                shift.call(this, translateVal_2, this.spaceship.velocity.y);
            }
            else {
                shift.call(this, 0, Math.abs(misc_1.getTranslateY(document.body)));
            }
        }
