...
function wrapWords(str) {
    return str
        .split(' ')
        .map(function (w) { return react_1.default.createElement("span", { className: "shootable_el" }, w); });
}
